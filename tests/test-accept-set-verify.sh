...
run_fix eval-round-F4.md;  expect_block   "F4 P3 sliced-corpus (U axis, 12<256) -> block"
export SW_AASC_CORPUS_FLOOR=8
run_fix eval-round-F4.md;  expect_noblock "F4 floor=8 -> no block (SW_AASC_CORPUS_FLOOR tunable)"
