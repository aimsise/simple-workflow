...
### 15 Skill x Verification Category Matrix

| Skill | A: dmi | B: AskUQ | C: Skill委譲 | D: Agent委譲 | E: args | F: fork | G: Status | H: hook | I: KB | J: Policy | K: kb-suggested |
|-------|--------|----------|-------------|-------------|---------|---------|-----------|---------|-------|-----------|-----------------|
| commit | x | | | | x | | | | | | |
| ticket-move | x | | | | x | | | | | | |
| investigate | x | | | x | x | x | | | | | |
